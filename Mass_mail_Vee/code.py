...
for items in l:
    ...
    try:       
        email_send = str(items) #Ask for entering E-mail address to whom mail to be sent
        ...
        #Subject of mail
        subject = 'You Have Two More Days, Go Win The Melodic Photography Contest| Vee Studio'
        ...
        #filename='QR.png'  # Name of atttachment to be sent.Must be in same folder as code
